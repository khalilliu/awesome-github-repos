...
*   [anxndsgn/figui](https://github.com/anxndsgn/figui) - figma ui3 style components using react and tailwind
...
*   [tysonthomas9/browser-operator-devtools-frontend](https://github.com/tysonthomas9/browser-operator-devtools-frontend) - Browser Operator - The Chromium browser with built in Multi-Agent
...
*   [imrofayel/fylepad](https://github.com/imrofayel/fylepad) - an aesthetic notepad with Markdown.
...
*   [onwidget/tailnext](https://github.com/onwidget/tailnext) - ⭕️ TailNext: Free template using Next.js 14 app router and Tailwind CSS.
...
*   [linode/manager](https://github.com/linode/manager) - The Akamai Connected Cloud Manager is an open-source, single-page application serving as the official UI for interacting with the Linode API. It is trusted by hundreds of thousands of customers to manage their Linode services.
...
*   [geeeeeeeek/videoproject](https://github.com/geeeeeeeek/videoproject) - A video website based on Django/Vue.  ビデオ・オン・デマンド・システム、python+Djangoによるビデオ管理システムの開発 - 卒業設計 - コース設計
